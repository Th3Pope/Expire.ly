...
<body style="background-color: #f9f3db;">
    ...
    <div class="row">
        <div class="col">
            <h1 class="text-center" style="padding: 0px;margin-bottom: 16px;margin-top: 8px;">Your Donation Will Help Many</h1>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12"> <div class="hotel-search">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA4ixG-nfXNfTU8Rwa7pC2Erdht2h88lmE&libraries=places&callback=initMap"
        async defer></script>
</div>
            </div>
        </div>
